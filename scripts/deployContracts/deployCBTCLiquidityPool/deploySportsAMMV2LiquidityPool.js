...
async function main() {
	...
	const collateralKey = ethers.encodeBytes32String('BTC');
	...
	const maxAllowedDeposit = '100000000';
		...
		[
			{
				...
				_collateral: cbtcCollateralAddress,
	...
	setTargetAddress('SportsAMMV2LiquidityPoolCBTC', network, sportsAMMV2LiquidityPoolAddress);
	await delay(5000);
	...
	setTargetAddress(
		'SportsAMMV2LiquidityPoolImplementationCBTC',
		network,
		sportsAMMV2LiquidityPoolImplementationAddress
	);
	...
	setTargetAddress(
		'SportsAMMV2LiquidityPoolProxyAdminCBTC',
		network,
