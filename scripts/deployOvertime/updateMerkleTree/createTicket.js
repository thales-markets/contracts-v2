...
async function createTicket() {
	...
	const sportsAMMV2Manager = sportsAMMV2ManagerContract.attach(sportsAMMV2ManagerAddress);
	...
	await tx.wait().then(async () => {
		const activeTickets = await sportsAMMV2Manager.getActiveTickets(0, 10);
